            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="caption">
                            <a href="javascript:void(0)" class="btn btn-success btn-sm" data-toggle="tooltip" title="View">Pending Order Details</a>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-actions text-center">
                            <a href="{!! route('backend.admin.order.pending-order.reject', $order->id) !!}" onclick="return confirm('Are you sure to reject this order?')" class="btn btn-danger" data-toggle="tooltip" title="Reject This Order">Reject</a>
                            <a href="{!! route('backend.admin.order.pending-order.accept', $order->id) !!}" onclick="return confirm('Are you sure to accept this order?')" class="btn btn-success" title="Accept This Order">Accept</a>
                        </div>
                    </div>
                </div>
