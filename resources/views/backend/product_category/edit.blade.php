        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{!! route('backend.admin.product.category.update', $edit_category->id) !!}" class="horizontal-form" method="post" enctype="multipart/form-data">
                            @method('patch')
                            {!! csrf_field() !!}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group @if ($errors->has('title')) has-error @endif">
                                            ...
                                            <input type="text" name="title" id="title" value="{!! $edit_category->title !!}"
                                        ...
                                        <div class="form-group @if ($errors->has('parent_id')) has-error @endif">
                                            ...
                                            <select id="parent_id" name="parent_id" class="form-control">
                                                ...
                                                @foreach($categories as $rows)
                                                    <option value="{{ $rows->id }}" {!! ($edit_category->parent_id == $rows->id)?'selected':'' !!}>{{ $rows->title }}</option>
                                                    {{--@php($i = 0)
                                                    @if(count($rows->childs))
                                                        @php($i++)
                                                        @include('backend.product_category.__edit_category_child_list_in_select',['childs' => $rows->childs])
                                                    @endif--}}
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group @if ($errors->has('image')) has-error @endif">
                                            ...
                                            <img src="{!! asset($edit_category->image) !!}" alt="Category Image" style="max-height:80px;">
                                            <br>
                                            @if($errors->has('image'))
                                                <span class="help-block">{!! $errors->first('image') !!}</span>
                                            @else
                                                <span class="help-block"> [If you not want to change keep it blank.] </span>
                                            @endif
                                        </div>
                                    </div>
                                    <!--/span-->
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group @if ($errors->has('featured')) has-error @endif">
                                            ...
                                            <input type="checkbox" name="featured" value="1" id="featured" {!! ($edit_category->featured == 1)?'checked':'' !!}>
                                            <br>
