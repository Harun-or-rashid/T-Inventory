        ...
        <div class="row">
                                ...
                                @if(!empty($colors))
                                    @foreach($colors as $color)
                                        <tr>
                                            ...
                                            <td><a href="{!! route('backend.admin.product.color.edit', $color->id) !!}" class="btn btn-danger btn-xs"><i class="fa fa-pencil-alt"></i></a></td>
                                        </tr>
                                    @endforeach
                                @endif
                                </tbody>
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{!! route('backend.admin.product.color.store') !!}" class="horizontal-form" method="post">
                            {!! csrf_field() !!}
                            <div class="form-body">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group @if ($errors->has('title')) has-error @endif">
                                            ...
                                            <input type="text" name="title" id="title" value="{!! old('title') !!}"
                                                   class="form-control" placeholder="Enter Color Title" required>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group @if ($errors->has('color_code')) has-error @endif">
                                            ...
                                            <input type="color" name="color_code" id="color" value="{!! old('color_code') !!}" class="form-control">
