            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="caption">
                            <a href="javascript:void(0)" class="btn btn-success btn-sm" data-toggle="tooltip" title="View">Rejected Order List</a>
                        </div>
                                ...
                                @if(!empty($rejected_orders))
                                    @foreach($rejected_orders as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{!! route('backend.admin.order.rejected-order.show', $row->id) !!}" class="btn btn-success btn-square btn-xs blue" data-toggle="tooltip" title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                </div>
                                            </td>
