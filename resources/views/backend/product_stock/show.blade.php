            ...
            <div class="col-md-12">
                <div class="card card-primary m-2">
                    <div class="card-header">
                        <a href="{!! route('backend.product.product.index') !!}" class="btn btn-success btn-sm" data-toggle="tooltip" title="List">List</a>
                        <a href="{!! route('backend.product.product.edit', $product->id) !!}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Edit">Edit</a>
                        <div class="tools">
