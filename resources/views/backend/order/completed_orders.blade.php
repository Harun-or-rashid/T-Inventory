            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="caption">
                            <a href="javascript:void(0)" class="btn btn-success btn-sm" data-toggle="tooltip" title="View">Completed Order List</a>
                        </div>
                                ...
                                @if(!empty($completed_orders))
                                    @foreach($completed_orders as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{!! route('backend.admin.order.completed-order.show', $row->id) !!}" class="btn btn-success btn-square btn-xs blue" data-toggle="tooltip" title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                </div>
                                            </td>
